...
const mudarQuantidade = () => {
  ...
  seleciona(".pizzaInfo--qtmais").addEventListener("click", () => {
    ...
    console.log("Adicionei uma pizza e ficaram " + quantPizzas);
  });
  ...
  seleciona(".pizzaInfo--qtmenos").addEventListener("click", () => {
    if (quantPizzas > 1) {
      quantPizzas--;
      seleciona(".pizzaInfo--qt").innerHTML = quantPizzas;
      console.log("Tirei uma pizza e ficaram " + quantPizzas);
    }
  });
};
// /aula 05
...
const adicionarNoCarrinho = () => {
  seleciona(".pizzaInfo--addButton").addEventListener("click", () => {
    ...
    console.log("Pizza é : " + nome);
    // tamanho
    size = seleciona(".pizzaInfo--size.selected").getAttribute("data-key");
    console.log("Tamanho " + size);
    // quantidade
    console.log("Quant. " + quantPizzas);
    // preco
    price = seleciona(".pizzaInfo--actualPrice").innerHTML.replace(
      "R$&nbsp;",
      ""
    );
    ...
    let identificador2 = pizzaJson[modalKey].name + "/ tamanho " + size;
...
const atualizarCarrinho = () => {
  ...
  if (cart.length > 0) {
    ...
    valorTotal = `total atualizado ${total}`;
